...
@Slf4j
public class CoronaSwitzerlandCasesData extends CoronaData {
	 ...
	 * @param props
	 */
	public CoronaSwitzerlandCasesData(String line, FederalStatesProperties props) {
		String[] a = line.split(",(?=([^\\\"]*\\\"[^\\\"]*\\\")*[^\\\"]*$)");
